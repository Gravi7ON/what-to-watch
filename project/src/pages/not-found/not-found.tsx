...
function NotFound(): JSX.Element {
  return (
    <div className="content_not-found">
        ...
        <svg className="vector_not-found" width="1123" height="837" viewBox="0 0 1123 837" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <g id="sky">
            ...
            <g id="stars_not-found">
              ...
              />
              <path id="Vector_12"
                d="M68.98 422.67H66.91V420.6H66.07V422.67H64V423.51H66.07V425.58H66.91V423.51H68.98V422.67Z" fill="white"
              />
              <path id="Vector_13"
            ...
            <g id="rocket_not-found">
              ...
              <g id="body-rocket">
                ...
                <g id="Group" opacity="0.1">
                  <path id="Vector_20" opacity="0.1" d="M665.261 656.998H682.881L681.701 648.948H666.441L665.261 656.998Z"
                    fill="black"
                  />
                </g>
                ...
                <g id="Group_2" opacity="0.1">
                  <path id="Vector_23" opacity="0.1" d="M587.311 656.998H604.931L603.741 648.948H588.491L587.311 656.998Z"
                    fill="black"
                  />
                </g>
                <path id="Vector_24"
      ...
      <div className="text_not-found">
        <h1 className="mistake_not-found">404 Error</h1>
        <h2>Failed to start :(</h2>
        <h3>Page not found <Link className="home-from_not-found" to={AppRoute.Main}>Return main</Link></h3>
      </div>
    </div>
  );
}
